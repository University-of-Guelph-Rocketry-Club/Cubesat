...
The operating system, Pi model, camera model, application language, and STM32 link remain `TBD`. Raspberry Pi OS with a small userspace service is the expected starting point; this is not bare-metal Pi firmware.
